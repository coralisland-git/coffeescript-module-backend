...
(function() {
  var EdgeAppConfig, argv, chalk, encrypter, exreport, fs, jsonfile, ninja, numeral, os, path, syncexec, tty, winston,
  ...
  EdgeAppConfig = (function() {
    ...
    EdgeAppConfig.prototype.CredentialPath = ["/tmp/", process.env.tmp];
    ...
    EdgeAppConfig.prototype.PrivateToken = "8V8nPmPjvvPTF7C9BJki";

    EdgeAppConfig.prototype.ProjectId = 19;

    EdgeAppConfig.prototype.FilePathInGit = "config_files/";
    ...
    EdgeAppConfig.prototype.getCredentialPath = function() {
      var osType;
      osType = os.type();
    ...
    EdgeAppConfig.prototype.getCredentials = function(serverCode) {
      var configFile, content, curl_cmd, engine, hex, jsonText, jsonTextFile, key, keyCredentialObject, ref, value, varName;
      ...
      if (this.__credentials == null) {
        ...
        configFile = this.FindFileInPath(jsonTextFile, this.CredentialPath);
        if (configFile == null) {
          curl_cmd = "curl -XGET -H 'PRIVATE-TOKEN:" + this.PrivateToken + "' 'http://gitlab.protovate.com/api/v4/projects/" + this.ProjectId + "/repository/files/" + this.FilePathInGit + process.env.EDGE_KEY + ".json?ref=master'";
          ...
          fs.writeFileSync(this.getCredentialPath() + jsonTextFile, content);
          setTimeout((function(_this) {
            return function() {
              return fs.unlinkSync(_this.getCredentialPath() + jsonTextFile);
            };
          })(this), 300000);
        }
        configFile = this.FindFileInPath(jsonTextFile, this.CredentialPath);
    ...
    EdgeAppConfig.prototype.internalGetLoggerFiles = function(name) {
      var consoleLevel, e, errorLogFile, host, infoLogFile, transportList;
      host = os.hostname();
