...
(function() {
  ...
  EdgeAppConfig = (function() {
    ...
    EdgeAppConfig.prototype.ConfigPath = __dirname + "/../Config";
    ...
    EdgeAppConfig.prototype.getCredentials = function(serverCode) {
      var engine, hex, jsonText, key, ref, value, varName;
      if ((serverCode != null) && (module.exports[serverCode] != null)) {
        return module.exports[serverCode];
      }
      if (this.__credentials == null) {
        key = fs.readFileSync(this.ConfigPath + "/key.txt");
        key = key.toString();
        engine = encrypter(key);
        if (this.devMode) {
          jsonText = fs.readFileSync(this.ConfigPath + "/credentials_dev.json");
        } else {
          jsonText = fs.readFileSync(this.ConfigPath + "/credentials.json");
        }
