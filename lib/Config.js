...
(function() {
  ...
  EdgeAppConfig = (function() {
    ...
    EdgeAppConfig.prototype.FindFileInPath = function(filename, pathList, returnPath) {
      var e, error, filenameTest, i, len, pathName, stat;
      if (returnPath == null) {
        returnPath = false;
      }
    ...
    EdgeAppConfig.prototype.getLogger = function(name) {
      var consoleLevel, errorLogFile, infoLogFile, paperTrailConfig, paperTrailLogger, transportList;
      if (this.__logs == null) {
        this.__logs = {};
      }
      consoleLevel = "log";
      ...
      if (this.__logs[name] == null) {
        infoLogFile = this.getDataPath("logs/" + name + "-info.log");
        errorLogFile = this.getDataPath("logs/" + name + "-error.log");
        transportList = {
          transports: [
