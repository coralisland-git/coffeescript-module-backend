...
(function() {
  var EdgeAppConfig, argv, chalk, encrypter, exreport, fs, jsonfile, newPromise, ninja, numeral, os, tty, winston,
  ...
  EdgeAppConfig = (function() {
    EdgeAppConfig.newPromise = newPromise;
    ...
    EdgeAppConfig.prototype.ConfigPath = [__dirname + "/../Config/", process.env.HOME + "/Config/", __dirname];
